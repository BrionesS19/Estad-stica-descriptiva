...
#Histograma
ggplot(df_ejer_c)+
  geom_histogram(aes(x = F_sim, y = after_stat(density)), bins = 100, fill="#F5F5DC", color="black", alpha=0.7)+
  geom_function(fun=function(x) df(x, a, b), color ="#8B0000", linewidth = 1.2)+
  xlim(0, 7.5)+
  theme_bw()
```
