...
#facet_wrap para separarloen diferentes graficas
...
```{r}
#| label: monedas-geometrica
# Parámetro
p_cara <- 0.5

# Calcular probabilidades para 5 lanzamientos
k_moneda <- 4
prob_geometrica_5 <- dgeom(k_moneda , p_cara)  

# Calcular probabilidades para mas de 3 lanzamientos
prob_geometrica_mas_3 <- 1 - pgeom(2, p_cara)
...
cat("La probabilidad de obtener exactamente 5 lanzamientos", prob_geometrica_5, "\n")
cat("La probabilidad de obtener mas de 3 lanzamientos", prob_geometrica_mas_3, "\n")
cat("Media (ensayos esperados):", media_moneda, "\n")
cat("Varianza:", varianza_moneda, "\n")
cat("Desviación estándar:", round(desv_std_moneda, 4), "\n")
...
# Preguntas de interés
prob_mas_100 <- 1 - sum(prob_calidad[1:100])

cat("Probabilidades de interés:\n")
cat("P(primera defectuosa despues de 100):", round(prob_mas_100, 4), "\n")
...
calidad_data <- data.frame(
  k = k_calidad[1:100],
  probabilidad = prob_calidad[1:100]
)
